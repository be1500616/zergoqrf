...
SignUpUseCase = EmailSignUpUseCase
SignInUseCase = EmailSignInUseCase
RefreshTokenUseCase = TokenRefreshUseCase
AnonymousSessionUseCase = CreateAnonymousSessionUseCase
GetCurrentUserUseCase = UserProfileUseCase
