...
## Acceptance Criteria
1. QR codes contain a simple, public URL in the format `https://app.zergoqrf.com/menu/{uniqueCode}/{tableId}`.
...
- Perform the required integration for with the other part of the application.
...
| 2025-09-25 | 1.1     | Updated URL format to use unique code instead of slug. | Roo |
