...
⚡ **Instant Access** - Direct link: `app.zergoqr.com/menu/{restaurantCode}/{tableId}`
...
```
QR Code Content: https://app.zergoqr.com/menu/TAJMAHAL/table-05

Components:
- restaurantCode: "TAJMAHAL" (Short, memorable code)
...
1. **[Story 2.1: Simple QR Code Generation](../stories/story-2.1-simple-qr-generation.md)**
   ...
   - Generate public QR codes with restaurantCode/tableId
...
CREATE TABLE qr_codes (
    ...
    restaurant_code VARCHAR(8) NOT NULL, -- Unique restaurant code
...
GET / menu / { restaurantCode } / { tableId }; // Public menu access
...
graph TD
    ...
    B --> C[Create restaurantCode/tableId URL]
